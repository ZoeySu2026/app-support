...
APPS = {
    ...
    "forklift": {
        ...
        "faq": [
            ...
            ("免費可以用到什麼程度？",
             "<p>術科「工作項目01」整章免費，含完整解析；模擬考可免費試考一次。"
             "解鎖後開放全題庫解析與無限次模擬考。</p>"),
            ("付了錢卻沒解鎖",
             "<p>先確認網路正常，然後到「我的 → 還原購買」。若仍未恢復，請來信並附上購買收據。</p>"),
            ("換手機之後進度不見了",
             "<p>學習紀錄只存在裝置本機，重裝或換機不會轉移。但「完整解鎖」是跟著你的 Apple ID 的，"
             "在新裝置點「還原購買」即可恢復，不需再付一次。</p>"),
            ("購買頁顯示「取得價格中」",
             "<p>表示暫時連不上 App Store。確認網路後按「重新取得價格」。</p>"),
            ("有術科教學嗎？",
        ...
        "privacy_extra": [
            ...
            ("購買",
             "<p>「完整解鎖」為一次性買斷，透過 Apple 的 App 內購買機制完成。交易由 Apple 處理，"
             "我們不會收到也不會儲存你的付款資訊。App 僅在裝置上記錄「是否已解鎖」這一個狀態。</p>"),
            ("通知",
